        ...
        <section className="work-legend">
          ...
          <div className="work-legend-item-wrapper col-6 row">
            <div className="work-legend-item col-5">
              <img src={icoApp} width="18" height="18" />
              App
            </div>
            <div className="work-legend-item col-5">
              <img src={icoWeb} width="18" height="18" />
              Web
            </div>
            <div className="work-legend-item col-5">
              <img src={icoCMS} width="18" height="18" />
              CMS
            </div>
            <div className="work-legend-item col-5">
              <img src={icoUIUX} width="18" height="18" />
              UIUX
            </div>
          </div>
        </section>
      ...
      <section className="work-filter">
        <section className="work-filter-item-wrapper">
          {workFilters.map((workFilter, index) => (
            <a className="work-filter-item" key={index}>
              <img src={workFilter.img} />
          ...
          <a className="work-filter-item">
            <img src={imgWTS} />
            <div className="info-wrapper">
              <p className="info-work-category">Transport & Logistics</p>
              <p className="info-work-name">Woodlands Transport</p>
              <div className="info-work-platform-wrapper">
                <div
                  className="info-work-platform"
                  style={{ backgroundImage: `url(${icoApp})` }}
                ></div>
                <div
                  className="info-work-platform"
                  style={{ backgroundImage: `url(${icoWeb})` }}
                ></div>
                <div
                  className="info-work-platform"
                  style={{ backgroundImage: `url(${icoCMS})` }}
                ></div>
                <div
                  className="info-work-platform"
                  style={{ backgroundImage: `url(${icoUIUX})` }}
                ></div>
              </div>
            </div>
          </a>
